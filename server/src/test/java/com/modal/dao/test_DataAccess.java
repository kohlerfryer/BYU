...
public class test_DataAccess {
    ...
    public void testRead() throws SQLException {
        int id = this.dataAccess.create(this.relation, this.attributes, this.initialValues);
        ResultSet result = this.dataAccess.get(this.relation, this.key, this.delimeter, Integer.toString(id));
    ...
    public void testDelete() throws SQLException{
        int id = this.dataAccess.create(this.relation, this.attributes, this.initialValues);
	    assertTrue(this.dataAccess.delete(this.relation, this.key, this.delimeter, Integer.toString(id)));
    }
